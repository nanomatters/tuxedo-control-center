...
public:
  ...
  bool setChargingProfile( int startThreshold, int endThreshold, int chargeType );
  std::optional< std::string > getChargingState();
...
private:
  ...
  static constexpr const char *DBUS_PATH = "/com/tuxedocomputers/tccd";
